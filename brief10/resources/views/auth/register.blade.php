    ...
    <div class="w-4/12 bg-white p-6 rounded-lg">
        <form action="{{route('register')}}" method="post">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="username" id="Username" placeholder="Your UseName" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('username') border-red-500 @enderror"  value="{{ old('username') }}">
                @error('username')
                <div class="text-red-500 mt-2 text-sm">
                    {{$message}}
                </div>
            ...
            <div class="mb-4">
                ...
                <input type="password" name="password_confirmation" id="Password" placeholder="Repeat Your Password" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('password') border-red-500 @enderror" value="{{ old('password') }}">
                @error('password')
                <div class="text-red-500 mt-2 text-sm">
                    {{$message}}
                </div>
